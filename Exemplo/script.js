...
function verificarResposta1() {
    ...
    const respostaCorreta = "128 bits"; // Exemplo de resposta correta
...
const recompensas = [
    new Recompensa(" IPv6", "Complete o desafio IPv6"),
    new Recompensa(" Ethernet", "Responda corretamente ao desafio Ethernet"),
    new Recompensa("TCP/UDP", "Acerte o desafio TCP/UDP"),
